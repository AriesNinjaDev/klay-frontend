    ...
    return (
        <div style={{ marginTop: "10px" }}>
            ...
            <Checkbox
                ...
                description="Launch Klay when you log into your computer."
            />
            ...
            <Checkbox
                ...
                description="Instead of closing, Klay will hide in your tray."
            />
            <Checkbox
                ...
                description="Rep Klay on your Discord status."
            />
            {/* <Checkbox
            ...
            <Checkbox
                ...
                description="Let Klay use its own window frame."
            />
