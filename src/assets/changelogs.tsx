...
export const changelogEntries: Record<number, ChangelogPost> = {
    ...
    2: {
        ...
        content: [
            ...
            "If you want to learn more about how we're making Klay safer for you, check out our new blog post :point_right: [https://revolt.chat/posts/improving-user-safety](https://revolt.chat/posts/improving-user-safety)",
        ],
    },
    3: {
